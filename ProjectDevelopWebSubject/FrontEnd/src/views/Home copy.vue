<template>
  ...
  <v-card class="pa-4" elevation="3">
    ...
    <v-container class="text-center">
      <h1 class="text-h4 font-weight-bold">Giới Thiệu: Hệ Thống Theo Dõi Mượn Sách</h1>
      ...
      <v-row>
        ...
        <v-col cols="12" md="4">
          <v-card class="elevation-1 text-center" to="/sach">
            ...
            <v-card-subtitle class="font-weight-bold">Quản Lý Sách</v-card-subtitle>
        ...
        <v-col cols="12" md="4">
          <v-card class="elevation-1 text-center" to="/theodoimuonsach">
            ...
            <v-card-subtitle class="font-weight-bold">Theo dõi mượn sách</v-card-subtitle>
        ...
        <v-col cols="12" md="4">
          <v-card class="elevation-1 text-center" to="docgia">
            ...
            <v-card-subtitle class="font-weight-bold">Quản Lý Độc Giả</v-card-subtitle>
    ...
    <v-container class="text-center">
      <v-btn color="primary" dark large @click="scrollUp(-200)">Bắt Đầu Sử Dụng</v-btn>
    </v-container>
  </v-card>
  ...
  <v-container fluid>
    <v-card>
      ...
      <v-card-text>
        <v-btn small color="primary" @click="isAdding = !isAdding" v-if="!isAdding && this.getAuth.chucvu">
          Thêm hoặc cập nhật
        </v-btn>
            ...
            <v-col cols="12" sm="6" md="4">
              <v-card class="ma-3" outlined>
                ...
                <v-card-text>
                  ...
                  <p><strong>Nguồn gốc/Tác giả:</strong> {{ sach.nguongoc_tacgia }}</p>
                </v-card-text>
                <v-card-actions>
                  <v-btn small color="primary" v-if="this.getAuth.chucvu" @click="editSach(sach._id)">
                    Chỉnh sửa
                  </v-btn>
                  <v-btn small color="primary" v-if="this.getAuth.chucvu" @click="deleteSach(sach._id)">
                    Xóa
                  </v-btn>
                  <v-btn small color="primary" v-if="!this.getAuth.chucvu" @click="muonSach(sach._id)">
                    Mượn sách
                  </v-btn>
                </v-card-actions>
              </v-card>
