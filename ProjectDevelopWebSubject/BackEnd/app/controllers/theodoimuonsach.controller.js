...
exports.findAll = async (req, res, next) => {
  try {
    ...
    return next(
      new ApiError(
        500,
        `An error occurred while retrieving records: ${error.message}`
      )
    );
  }
};
...
exports.findOne = async (req, res, next) => {
  try {
    ...
    return next(
      new ApiError(
        500,
        `Error retrieving record with id=${req.params.id}: ${error.message}`
      )
    );
  }
};
...
exports.update = async (req, res, next) => {
  ...
  try {
    ...
    return next(
      new ApiError(
        500,
        `Error updating record with id=${req.params.id}: ${error.message}`
      )
    );
  }
};
...
exports.delete = async (req, res, next) => {
  try {
    ...
    return next(
      new ApiError(
        500,
        `Could not delete record with id=${req.params.id}: ${error.message}`
      )
    );
  }
};
...
exports.deleteAll = async (req, res, next) => {
  try {
    ...
    return next(
      new ApiError(
        500,
        `An error occurred while removing all records: ${error.message}`
      )
    );
  }
};
...
exports.findByDocGia = async (req, res, next) => {
  try {
    ...
    return next(
      new ApiError(
        500,
        `An error occurred while recieving all records: ${error.message}`
      )
    );
  }
};
