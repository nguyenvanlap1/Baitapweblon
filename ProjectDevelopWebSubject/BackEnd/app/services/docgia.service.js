...
class DocGiaService {
    ...
    extractDocGiaData(payload) {
        ...
        if (!payload._id || !payload.holot || !payload.ten || !payload.ngaysinh || !payload.phai || !payload.diachi || !payload.dienthoai) {
            throw new Error("Missing required fields: '_id', 'holot', 'ten', 'ngaysinh', 'phai', 'diachi', 'dienthoai', and/or 'password'");
        }
